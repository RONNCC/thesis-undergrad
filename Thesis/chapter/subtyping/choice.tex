...
\begin{rules}[subtyping-choice]{Subtyping internal and external choices}
  \infer=[\Sub\internal]{\internals{A}{I} \sub \internals{A'}{J}}
    {I \subseteq J & A_\indexVar \sub A'_\indexVar~\text{for}~\indexVar \in I}
