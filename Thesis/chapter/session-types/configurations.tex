...
\begin{definition}[Domain and Free Variables]
We define
...
\end{lemma}
\begin{proof}
  By induction on the derivation. \todo{Do the configuration inversion proof.}
\end{proof}
