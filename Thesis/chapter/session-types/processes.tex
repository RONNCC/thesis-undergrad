...
followed by the matching receiving construct. Discussion of other typing rules is given in \cref{base:type-assignment}. Here, cut and $\mathtt{recv}$ bind the spawned or received channel name, which means these are identified up to alpha conversion.

\todo{Write the notation for substitution somewhere.}
