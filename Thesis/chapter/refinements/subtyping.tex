...
\begin{proof}
  ...
  \todo{Is the application of trans here OK for readability? It is fine form a technical standpoint by inlining the definition.}

  \item \todo{Do non structural rules on $A$.}
  \end{itemize}
\end{proof}
