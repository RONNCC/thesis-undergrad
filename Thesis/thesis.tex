...
\documentclass[final, letterpaper, oneside, 11pt]{thesis}
...
``\textit{Oh, wow. That's an intense line of questioning, Snuffles.}''
\begin{flushright}
  Summer Smith
\end{flushright}

``\textit{When life gives you lemons, don't make lemonade. Make life take the lemons back! Get mad! I don't want your damn lemons, what the hell am I supposed to do with these?}''
\begin{flushright}
  Cave Johnson
\end{flushright}
...
\clearpage
\input{appendix/concrete-syntax}
