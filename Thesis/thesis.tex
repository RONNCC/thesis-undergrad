...
% \input{chapter/background/domains}
% \input{chapter/background/metric-spaces}
% \input{chapter/background/ideals}
% \input{chapter/background/ideal-semantics}
% \input{chapter/background/tree-grammars}
% \input{chapter/background/tree-automata}

\include{chapter/session-types}
\input{chapter/session-types/types}
\input{chapter/session-types/processes}
\input{chapter/session-types/recursive}
%\input{chapter/session-types/subtyping}
\input{chapter/session-types/configurations}
\input{chapter/session-types/operational-semantics}

\include{chapter/refinements}
...
\include{appendix/appendixA}	% Appendix Title
...
\bibliography{bibliography}  % Reference (bibliography) information is stored in the file named "bibliography.bib"
