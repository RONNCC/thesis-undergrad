...
\begin{mathpar}
  ...
  \and \infer[\intersect\Left]{\typeRecAJR{\ctx, c : A \intersect B}{P}{d}{\typeList}}
    {\typeRecAJR{\ctx, c : A, c : B}{P}{d}{\typeList}}
  % Union
  \\ \infer[\union\Right]{\typeRecAJR \ctx P c {A \union B, \typeList}}
    {\typeRecAJR \ctx P c {A, B, \typeList}}
  \and \infer[\union\Left]{\typeRecAJR{\ctx, c : A \union B} P d \typeList}
    { \typeRecAJR {\ctx, c : A} P d \typeList
    & \typeRecAJR {\ctx, c : B} P d \typeList
    }
  % Recursive
  \\ \infer[\mu\Right]{\typeRecAJ P c {\recursive t A, \typeList}}
    { \typeRecAJ P c {\subst {\recursive t A} t A, \typeList} }
  \and \infer[\mu\Left]{\typeRecAJR {\ctx, c : \recursive t A} P d {\typeList}}
    { \typeRecAJR {\ctx, c : \subst {\recursive t A} t A} P d {\typeList} }
  % id and cut
  \\ \infer[\id]{ \typeRecAJR {\ctx, c : A} {\tfwd d c} {d} {A', \typeList} }
  ...
  \\ \infer[\terminate\Right]{\typeRecAJR{\emptyCtx}{\tclose c}{c}{\terminate, \typeList}}
   {}
  \and \infer[\terminate\Left]{\typeRecAJR{\ctx, c : \terminate}{\twait c P} d \typeList}
    { \typeRecAJR {\ctx \remove c} P d \typeList}
  % Tensor
  ...
  \and \infer[\tensor\Left]{ \typeRecAJR{\ctx, c : A \tensor B}{\trecv{d}{c}{P_d}}{e}{\typeList} }
    { \typeRecAJR{\ctx \remove c, d : A, c : B}{P_d}{e}{\typeList} }
  % Internal choice
  \and \infer[\internal\Right]{\typeRecAJR \ctx { \tselect{c}{i}{P} } {c} {\internals{A}{I}, \typeList }}
    { i \in I
    & \typeRecAJR \ctx {P}{c}{A_i}
    }
  \and \infer[\internal\Left]{ \typeRecAJR { \ctx, c : \internals{A}{I} } { \tcase{c}{\tbranches{P}{J}} } {d} {\typeList} }
   { I \subseteq J
   & \typeRecAJR{\ctx \remove c, c : A_k}{P_k}{d}{\typeList}~\text{for}~k\in I
   }
  % Lolli
  \and \infer[\lolli\Right]{ \typeRecAJR{\ctx}{\trecv{d}{c}{P_d}}{c}{A \lolli B, \typeList} }
    { \typeRecAJR{\ctx, d : A}{P_d}{c}{B} }
  \and \infer[\lolli\Left]{\typeRecAJR{\ctx, \ctx', c : A \lolli B}{ \tsend{c}{d}{P_d}{Q} } {e}{\typeList}}
    { \ctx \cap \ctx' = \emptyset
    & \typeRecAJR{\ctx}{P_d}{d}{A}
    & \typeRecAJR{\ctx' \remove c, c : B}{Q}{e}{\typeList}
    }
  % External choice
  ...
  \and \infer[\external\Left]{\typeRecAJR{\ctx, c : \externals{A}{I}} { \tselect{c}{i}{P} } {d} {\typeList}}
    { i \in I
    & \typeRecAJR{\ctx \remove c, c : A_i}{P}{d}{\typeList}
    }
\end{mathpar}
