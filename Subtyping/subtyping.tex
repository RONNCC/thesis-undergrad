...
\newcommand\execT[3]{\mathrm{exec}\;{#1}\;{#2}\;{#3}}
...
\newcommand\combine[3]{#1 \leftarrow #2 \Rightarrow #3}
\newcommand\ground[1]{#1~\mathrm{ground}}
\newcommand\mismatch[2]{\combine{#1}{#2}{\mathrm{err}}}
...
\begin{mathpar}
\infer{\combine{A_1 \intersect A_2}{\alpha}{B_1 \intersect B_2}}
 { \combine{A_1}{\alpha}{B_1}
 & \combine{A_2}{\alpha}{B_2}
 }
\and
\infer{\combine{A_1 \intersect A_2}{\alpha}{B_1}}
 { \combine{A_1}{\alpha}{B_1}
 & \mismatch{A_2}{\alpha}
 }
\and
\infer{\combine{A_1 \intersect A_2}{\alpha}{B_2}}
 { \mismatch{A_1}{\alpha}
 &\combine{A_2}{\alpha}{B_2} 
 }
%%%
%\\
%\infer{\combine{A}{B_1 \intersect B_2}{C_1 \intersect C_2}}
% { \combine{A}{B_1}{C_1}
% & \combine{A}{B_2}{C_2}
% }
%\and
%\infer{\combine{A}{B_1 \intersect B_2}{C_1}}
% { \combine{A}{B_1}{C_1}
% & \mismatch{A}{B_2}
% }
%\and
%\infer{\combine{A}{B_1 \intersect B_2}{C_2}}
% { \mismatch{A}{B_1}
% & \combine{A}{B_2}{C_2}
% }
%%%
\\
\infer{\combine{\tau \imp A}{\tau'}{A}}{\tau \le \tau'}
\and \infer{\combine{\tau \wedge A}{\tau'}{A}}{\tau \le \tau'}
\and \infer{\combine{A_1 \lolli A_2}{A'}{A_2}}{A' \sqsubseteq A_1}
\and \infer{\combine{A_1 \otimes A_2}{A'}{A_2}}{A_1 \sqsubseteq A'}
\end{mathpar}

We then define a typed operational semantics.

\begin{itemize}
\item Provider is $\otimes$:
\begin{gather*}
	\execT{\parens{\tseq {\toutc{c}{d}{P_d}} {Q} }}{c}{A}
	\otimes \execT{\parens{\tseq {\tint{d}{c}{B}} {R_d} }}{e}{E} \\
	\otimes\; \combine{A}{B}{A'}
	\lolli \{ \exists d'. \execT{P_{d'}}{d'}{B} \otimes \execT{Q}{c}{A'} \otimes \execT{R_{d'}}{e}{E} \}
\end{gather*}
\end{itemize}
